...
args.dataset_text_folder = '../data/example_unannotated_texts'
args.pretrained_model_folder = '../trained_models/conll_2003_zh'
arguments = vars(args)
...
def tagEntity(text):
	#temparg = {'train_model':False,'use_pretrained_model':True,'dataset_text_folder':'../data/example_unannotated_texts','pretrained_model_folder':'../trained_models/conll_2003_en'}
	#arguments = parse_arguments(train_model=False,use_pretrained_model=True,dataset_text_folder='../data/example_unannotated_texts',pretrained_model_folder='../trained_models/conll_2003_en')

	test= nn.predict(text, spacy_nlp)
	#print (test)
	#nn.close() 
	return jsonify(test)
